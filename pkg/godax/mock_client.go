...
// MockClient is responsible for stubbing requests in tests. If the Response field is set,
// the mock client will respond to each request with the Response. If Responses is set,
// the mock client will match subsequent requests to subsequent responses, moving along
// the array of Responses once for each request
